...
import com.pp.bayiri.Class.AubAdapter;
import com.pp.bayiri.Class.Constant;
import com.pp.bayiri.Class.HotelClass;
import com.pp.bayiri.R;
import com.pp.bayiri.Suspend.AubSusp;

import java.util.ArrayList;
import java.util.List;

public class AdAuberges extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.ad_auberges, container, false);

        tv= view.findViewById(R.id.id_aub_aj);
        enreg= view.findViewById(R.id.id_aub_enreg);
        susp= view.findViewById(R.id.id_aub_susp);
        disp= view.findViewById(R.id.id_aub_dip);
        rech= view.findViewById(R.id.ad_aub_rech);
        recyclerView= view.findViewById(R.id.ad_aub_recycl);
        layout= view.findViewById(R.id.absp_lay);
        ...
        userRef= FirebaseDatabase.getInstance().getReference().child(Constant.User)
                .child(Constant.location).child("Auberges");
        ...
        list= new ArrayList<>();
        list1= new ArrayList<>();
        adArticle= new AubAdapter(getActivity(), list);
        recyclerView.setAdapter(adArticle);

        tv.setOnClickListener(view1 -> {
            Intent intent =new Intent(getActivity(), AjoutAuberg.class);
        ...
        layout.setOnClickListener(view12 -> {
            Intent i= new Intent(getActivity(), AubSusp.class);
            i.putExtra("un", uName);
            startActivity(i);
        });
