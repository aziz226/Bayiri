...
import com.pp.bayiri.Suspend.VentMaisSusp;
import com.pp.bayiri.VenteClass.TmAdAdapetr;
import com.pp.bayiri.VenteClass.TmClass;

import java.util.ArrayList;
import java.util.List;

public class AdVenteMaison extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.ad_vente_maison, container, false);

        btn= view.findViewById(R.id.id_mais_vent_aj);
        enreg= view.findViewById(R.id.idvm_enreg);
        susp= view.findViewById(R.id.idvm_susp);
        disp= view.findViewById(R.id.idvm_dip);
        rech= view.findViewById(R.id.ad_vm_rech);
        recyclerView= view.findViewById(R.id.ad_vent_mais_recycl);
        suspLay= view.findViewById(R.id.vm_susp_lay);

        userRef= FirebaseDatabase.getInstance().getReference()
                .child(Constant.User).child(Constant.vente).child("Maison");

        reference= FirebaseDatabase.getInstance().getReference().child(Constant.User)
                .child(Constant.susp).child(Constant.vente).child("Maison");
        ...
        list= new ArrayList<>();
        list1= new ArrayList<>();
        adArticle= new TmAdAdapetr(getActivity(), list);
         loadPost();
        ...
        btn.setOnClickListener(view1 -> {
            Intent intent =new Intent(getActivity(), AjoutMaisVent.class);
        ...
        suspLay.setOnClickListener(view12 -> {
            Intent intent= new Intent(getActivity(), VentMaisSusp.class);
