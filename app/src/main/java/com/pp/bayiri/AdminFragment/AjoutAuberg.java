...
public class AjoutAuberg extends AppCompatActivity {

    private Button btn_save;
    private ImageView img, img1, img2, img3, img4;
    private TextInputEditText quart, type, code, hotName, caution, loy, userN;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ajout_auberg);


        btn_save= findViewById(R.id.au_save);
        img= findViewById(R.id.id_art_au_img);
        img1= findViewById(R.id.id_art_au_mini_img1);
        img2= findViewById(R.id.id_art_au_mini_img2);
        img3= findViewById(R.id.id_art_au_mini_img3);
        img4= findViewById(R.id.id_art_au_mini_img4);

        quart= findViewById(R.id.id_au_art_quart);
        //geograph= findViewById(R.id.id_au_art_geograph);
        code= findViewById(R.id.id_au_art_code);
        caution= findViewById(R.id.id_au_art_caution);
        loy= findViewById(R.id.id_au_art_loy);
        hotName= findViewById(R.id.au_name);
        ...
        btn_save.setOnClickListener(view -> {
            ...
            if (TextUtils.isEmpty(hotName.getText().toString())){
                ...
                dialog.setTitle("Ajout d'Auberge en cours");
                ...
                DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child(Constant.User)
                        .child(Constant.location).child("Auberges").child(code.getText().toString());
                ...
                userMap.put(Constant.pHeur, loy.getText().toString()+" F CFA");
                userMap.put(Constant.pJour, caution.getText().toString()+" F CFA");

                //userMap.put("susp", susp);

                reference.updateChildren(userMap).addOnCompleteListener(task -> {
                    if (task.isSuccessful()){
                        Toast.makeText(AjoutAuberg.this, "Vous venez d'ajouter une résidence en location.",
                                Toast.LENGTH_SHORT).show();
                        Intent intent= new Intent(AjoutAuberg.this, AddLocatHouse.class);
                        ...
                        Toast.makeText(AjoutAuberg.this, "Erreur: "+msg, Toast.LENGTH_SHORT).show();
                        dialog.dismiss();
                    }
                });
