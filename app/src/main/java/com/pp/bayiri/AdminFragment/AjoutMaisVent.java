...
public class AjoutMaisVent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ajout_mais_vent);
        ...
        btn_save= findViewById(R.id.vm_aj_save);
        img= findViewById(R.id.vm_img);
        img1= findViewById(R.id.vm_img1);
        img2= findViewById(R.id.vm_img2);
        img3= findViewById(R.id.vm_img3);
        img4= findViewById(R.id.vm_img4);

        //userN= findViewById(R.id.user_name);
        quart= findViewById(R.id.vm_aj_quart);
        geograph= findViewById(R.id.vm_aj_geograph);
        type= findViewById(R.id.vm_aj_type);
        code= findViewById(R.id.vm_aj_code);
        marg= findViewById(R.id.vm_aj_neg);
        prix= findViewById(R.id.vm_aj_pri);

        desc1= findViewById(R.id.vm_aj_des1);
        desc2= findViewById(R.id.vm_aj_des2);
        desc3= findViewById(R.id.vm_aj_des3);
        desc4= findViewById(R.id.vm_aj_des4);
        desc5= findViewById(R.id.vm_aj_des5);
        desc6= findViewById(R.id.vm_aj_des6);
        desc7= findViewById(R.id.vm_aj_des7);
        desc8= findViewById(R.id.vm_aj_des8);
        desc9= findViewById(R.id.vm_aj_des9);
        desc10= findViewById(R.id.vm_aj_des10);
        ...
        btn_save.setOnClickListener(view -> {
           ...
           /* if(TextUtils.isEmpty(userN.getText().toString())){
            ...
            if (TextUtils.isEmpty(quart.getText().toString())){
                ...
                Toast.makeText(this, "Entrer le prix de la maison", Toast.LENGTH_SHORT).show();
                ...
                DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child(Constant.User)
                        .child(Constant.vente).child("Maison").child(code.getText().toString());
                ...
                reference.updateChildren(userMap).addOnCompleteListener(task -> {
                    if (task.isSuccessful()){
                        Toast.makeText(AjoutMaisVent.this, "Vous venez d'ajouter une "+maison+" en location.",
                                Toast.LENGTH_SHORT).show();
                        Intent intent= new Intent(AjoutMaisVent.this, AjouterVente.class);
                        ...
                        Toast.makeText(AjoutMaisVent.this, "Erreur: "+msg, Toast.LENGTH_SHORT).show();
                        dialog.dismiss();
                    }
                });
            }
