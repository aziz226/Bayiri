...
import com.pp.bayiri.Details.AubDetail;
...
public class ScrollAubAdapter extends RecyclerView.Adapter<ScrollAubAdapter.MyHolder> {
        Context context;
        List<ScrollClass> list;

public ScrollAubAdapter(Context context, List<ScrollClass> list) {
...
public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        ...
        Intent intent= new Intent(context, AubDetail.class);
