...
import com.pp.bayiri.Details.ResidDetail;
...
public class ScrollResAdapter extends RecyclerView.Adapter<ScrollResAdapter.MyHolder> {
        Context context;
        List<ScrollClass> list;

public ScrollResAdapter(Context context, List<ScrollClass> list) {
...
public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        ...
        Intent intent= new Intent(context, ResidDetail.class);
