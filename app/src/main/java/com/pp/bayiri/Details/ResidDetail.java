...
public class ResidDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resid_detail);

        Bundle intent= getIntent().getExtras();
        String cod= intent.getString("code");

        img= findViewById(R.id.res_detail_img);
        img1= findViewById(R.id.res_detail_mini_img1);
        img2= findViewById(R.id.res_detail_mini_img2);
        img3= findViewById(R.id.res_detail_mini_img3);
        img4= findViewById(R.id.res_detail_mini_img4);

        d1= findViewById(R.id.res_des1);
        d2= findViewById(R.id.res_des2);
        d3= findViewById(R.id.res_des3);
        d4= findViewById(R.id.res_des4);
        d5= findViewById(R.id.res_des5);
        d6= findViewById(R.id.res_des6);
        d7= findViewById(R.id.res_des7);
        d8= findViewById(R.id.res_des8);
        d9= findViewById(R.id.res_des9);
        d10= findViewById(R.id.res_des10);

        loy= findViewById(R.id.res_detail_loyer);
        caution= findViewById(R.id.res_detail_caution);
        obli= findViewById(R.id.res_detail_obli);
        obli_pri= findViewById(R.id.res_detail_obli_pri);
        code= findViewById(R.id.res_code_loffr);
        ville= findViewById(R.id.id_resid_ville);
        quart= findViewById(R.id.id_resid_quartier);
    ...
    public void NousContacter(View view) {
        Intent intent= new Intent(ResidDetail.this, NousContacter.class);
        intent.putExtra("c", c);
        intent.putExtra("cx", "la résidence");
