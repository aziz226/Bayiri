...
public class VentMaisDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vent_mais_detail);

        Bundle intent= getIntent().getExtras();
        String cod= intent.getString("c");

        img= findViewById(R.id.vd_img);
        img1= findViewById(R.id.vd_img1);
        img2= findViewById(R.id.vd_img2);
        img3= findViewById(R.id.vd_img3);
        img4= findViewById(R.id.vd_img4);

        d1= findViewById(R.id.vd_des1);
        d2= findViewById(R.id.vd_des2);
        d3= findViewById(R.id.vd_des3);
        d4= findViewById(R.id.vd_des4);
        d5= findViewById(R.id.vd_des5);
        d6= findViewById(R.id.vd_des6);
        d7= findViewById(R.id.vd_des7);
        d8= findViewById(R.id.vd_des8);
        d9= findViewById(R.id.vd_des9);
        d10= findViewById(R.id.vd_des10);

        loy= findViewById(R.id.vd_pri);
        caution= findViewById(R.id.vd_marg);
        obli= findViewById(R.id.vd_vil);
        obli_pri= findViewById(R.id.vd_quart);
        code= findViewById(R.id.vd_code_loffr);

        userRef= FirebaseDatabase.getInstance().getReference()
                .child(Constant.User).child(Constant.vente).child("Maison").child(""+cod);
    ...
    public void NousContacter(View view) {
        Intent intent= new Intent(VentMaisDetail.this, NousContacter.class);
        intent.putExtra("c", c);
        intent.putExtra("cx", "l'achat de la maison");
