...
public class ModifAub extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modif_aub);

        btn_save= findViewById(R.id.aub_modif);
        ...
        userRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    ville.setText(""+snapshot.child(Constant.ville).getValue().toString());
