...
public class ModifRes extends AppCompatActivity {

    private Button btn_save;
    private ImageView img, img1, img2, img3, img4;
    private TextInputEditText quart, geograph, type, ville, perio, caution, loy, name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modif_res);

        btn_save= findViewById(R.id.rm_save);
        img= findViewById(R.id.rm_img);
        img1= findViewById(R.id.rm_img1);
        img2= findViewById(R.id.rm_img2);
        img3= findViewById(R.id.rm_img3);
        img4= findViewById(R.id.rm_img4);

        quart= findViewById(R.id.rm_quart);
        geograph= findViewById(R.id.rm_geograph);
        type= findViewById(R.id.rm_type);
        ville= findViewById(R.id.rm_ville);
        perio= findViewById(R.id.rm_period);
        caution= findViewById(R.id.rm_caution);
        loy= findViewById(R.id.rm_loy);
        name= findViewById(R.id.rm_resid_name);

        desc1= findViewById(R.id.rm_des1);
        desc2= findViewById(R.id.rm_des2);
        desc3= findViewById(R.id.rm_des3);
        desc4= findViewById(R.id.rm_des4);
        desc5= findViewById(R.id.rm_des5);
        desc6= findViewById(R.id.rm_des6);
        desc7= findViewById(R.id.rm_des7);
        desc8= findViewById(R.id.rm_des8);
        desc9= findViewById(R.id.rm_des9);
        desc10= findViewById(R.id.rm_des10);
        ...
        userRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    name.setText(""+snapshot.child("residName").getValue().toString());
        ...
        btn_save.setOnClickListener(view -> {
            ...
            userMap.put("residName", name.getText().toString());
