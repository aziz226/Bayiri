...
public class ModifVentMais extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.modif_vent_mais);

        btn_save= findViewById(R.id.vmo_aj_save);
        img= findViewById(R.id.vmo_img);
        img1= findViewById(R.id.vmo_img1);
        img2= findViewById(R.id.vmo_img2);
        img3= findViewById(R.id.vmo_img3);
        img4= findViewById(R.id.vmo_img4);

        quart= findViewById(R.id.vmo_aj_quart);
        geograph= findViewById(R.id.vmo_aj_geograph);
        ville= findViewById(R.id.vmo_aj_vil);
        prix= findViewById(R.id.vmo_aj_pri);
        marg= findViewById(R.id.vmo_aj_neg);
        type= findViewById(R.id.vmo_aj_type);

        d1= findViewById(R.id.vmo_aj_des1);
        d2= findViewById(R.id.vmo_aj_des2);
        d3= findViewById(R.id.vmo_aj_des3);
        d4= findViewById(R.id.vmo_aj_des4);
        d5= findViewById(R.id.vmo_aj_des5);
        d6= findViewById(R.id.vmo_aj_des6);
        d7= findViewById(R.id.vmo_aj_des7);
        d8= findViewById(R.id.vmo_aj_des8);
        d9= findViewById(R.id.vmo_aj_des9);
        d10= findViewById(R.id.vmo_aj_des10);
