...
import com.pp.bayiri.VenteClass.VmAdapter;
...
public class VentMaisSusp extends AppCompatActivity {


    private SearchView rech;
    private RecyclerView recyclerView;
    private List<TmClass> list;
    private VmAdapter adArticle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vent_mais_susp);


        rech= findViewById(R.id.vms_rech);
        recyclerView= findViewById(R.id.vms_recycl);
        ...
        list= new ArrayList<>();
        adArticle= new VmAdapter(this, list);
        loadPost();
