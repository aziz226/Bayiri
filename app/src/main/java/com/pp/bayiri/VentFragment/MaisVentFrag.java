package com.pp.bayiri.VentFragment;
...
import com.pp.bayiri.VenteClass.TmAdapter;
...
public class MaisVentFrag extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View view= inflater.inflate(R.layout.mais_vent_frag, container, false);

        ville= view.findViewById(R.id.ven_spinner_ville);
        type= view.findViewById(R.id.vent_spinner_type);
        horiRecy= view.findViewById(R.id.ven_hori_recyc);
        MainRecy= view.findViewById(R.id.ven_main_recyc);
        mainPay= view.findViewById(R.id.ven_main_pays);
        mainVill= view.findViewById(R.id.ven_main_ville);
        mainType= view.findViewById(R.id.ven_main_maisn_typ);
        ...
        list= new ArrayList<>();
        adapteur= new TmAdapter(getActivity(), list);
        ...
        userRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot ds:snapshot.getChildren()){
                    TmClass homeClass= ds.getValue(TmClass.class);
                    list.add(homeClass);
                }
