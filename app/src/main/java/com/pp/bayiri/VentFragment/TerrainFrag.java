...
import com.pp.bayiri.VenteClass.TerrAdapter;
...
public class TerrainFrag extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.terrain_frag, container, false);

        ville= view.findViewById(R.id.ter_spinner_ville);
        type= view.findViewById(R.id.ter_spinner_type);
        horiRecy= view.findViewById(R.id.ter_hori_recyc);
        MainRecy= view.findViewById(R.id.ter_main_recyc);
        mainPay= view.findViewById(R.id.ter_main_pays);
        mainVill= view.findViewById(R.id.ter_main_ville);
        mainType= view.findViewById(R.id.ter_main_maisn_typ);
        ...
        list= new ArrayList<>();
        adapteur= new TerrAdapter(getActivity(), list);
            ...
            userRef.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    for (DataSnapshot ds:snapshot.getChildren()){
                        ...
                        if (homeClass.getVille().equals(selectVille)){
                            list.add(homeClass);
