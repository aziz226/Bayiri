...
import com.pp.bayiri.Details.VentTerDetail;
import com.pp.bayiri.R;
import com.squareup.picasso.Picasso;

import java.util.List;

public class TerrAdapter extends RecyclerView.Adapter<TerrAdapter.MyHolder> {
    Context context;
    List<TmClass> list;

    public TerrAdapter(Context context, List<TmClass> list) {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        ...
        holder.car.setOnClickListener(view -> {
            Intent intent= new Intent(context, VentTerDetail.class);
            intent.putExtra("c", c);
