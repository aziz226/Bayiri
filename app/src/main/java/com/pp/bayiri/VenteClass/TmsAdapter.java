...
public class TmsAdapter extends RecyclerView.Adapter<TmsAdapter.MyHolder> {
    Context context;
    List<TmClass> list;

    public TmsAdapter(Context context, List<TmClass> list) {
        ...
        holder.btn.setOnClickListener(view -> {
            ...
            builder.setNegativeButton("Non", (dialogInterface, i) -> {
                    ...
                    .setPositiveButton("Oui", (dialogInterface, i) -> {
                        ...
                        d.setTitle("Mise en ligne cours...");
                                ...
                                if (snapshot.exists()){
                                    ...
                                    reference.removeValue().addOnCompleteListener(task1 -> {
                                        if (task1.isSuccessful()){
                                            ...
                                            // context.startActivity(new Intent(context, AdVenteTerrain.class));
